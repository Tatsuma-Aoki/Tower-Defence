...
public class Zombie extends BaseEnemy {
    ...
    private static final double ATTACK_POWER = 20;
    private static final double DEFAULT_HP = 50;
    ...
    public Zombie(GameObject root, GameObject parent, GameLevel level, ArrayList<Tower> targets,
        ...
        this.setImages(ImageManager.getInstance().getDivImage(ResourcePathDefines.ZOMBIE_IMAGES, 6, 4, 48, 48),
                TIME_PER_FRAME);
        this.hp = DEFAULT_HP;
