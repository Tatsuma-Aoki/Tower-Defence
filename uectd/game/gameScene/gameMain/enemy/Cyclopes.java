...
public class Cyclopes extends BaseEnemy {

    private final static float MOVE_SPEED = 45;
    private final static int TIME_PER_FRAME = 500;
    private static final double ATTACK_POWER = 75;
    private static final double DEFAULT_HP = 175;
    ...
    public Cyclopes(GameObject root, GameObject parent, GameLevel level, ArrayList<Tower> targets,
        ...
        this.setImages(ImageManager.getInstance().getDivImage(ResourcePathDefines.ENEMY3_IMAGES, 6, 4, 48, 48),
                TIME_PER_FRAME);
        this.hp = DEFAULT_HP;
