...
public class Goblin extends BaseEnemy {
    ...
    private final static float MOVE_SPEED = 80;
    private final static int TIME_PER_FRAME = 500;
    private static final double ATTACK_POWER = 15;
    private static final double DEFAULT_HP = 35;
    ...
    public Goblin(GameObject root, GameObject parent, GameLevel level, ArrayList<Tower> targets,
        ...
        this.setImages(ImageManager.getInstance().getDivImage(ResourcePathDefines.GOBLIN_IMAGES, 6, 4, 48, 48),
                TIME_PER_FRAME);
        this.hp = DEFAULT_HP;
