...
public class CannonTurret extends BaseTurret implements ActionListener {
    ...
    private final static double INTERCEPT_ATTACK_POWER = 10;
    private final static double LEVELUP_ATTACK_POWER = 1;
    private final static double INTERCEPT_COLLISION_RADIUS = 200;
    private final static double LEVELUP_COLLISION_RADIUS = 12;
    ...
    public CannonTurret(GameObject root, GameObject parent, IMoneyTransfer iMoneyTransfer) {
        super(root, parent, "Cannon", INTERCEPT_COLLISION_RADIUS + LEVELUP_COLLISION_RADIUS,
                INTERCEPT_ATTACK_POWER + LEVELUP_ATTACK_POWER, 1000, 10, 100,
                ImageManager.getInstance().getDivImage(ResourcePathDefines.CANNON_TURRET_IMAGES, 8, 1, 64, 64),
                iMoneyTransfer);
        depth = 1;
    }
    ...
    public void fireCannonball() {
        ...
        if (nearestEnemy != null) {
            Cannonball cannonball = new Cannonball(root, root, attackPower, rof, this, nearestEnemy);
            cannonball.position = this.position.clone();
